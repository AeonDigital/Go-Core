...
func TestOptions_ValidateExclusivePaths(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectError:   true,
			expectedError: "[CTX: ERR_XCONFIG][ERR: E3007][MSG: mutual exclusivity violation (choose only one)][INFO: 'FilePath': '/path/to/config.json' | 'DirPath': '/path/to/dir' | 'ConfigPath': '']",
		},
		{
			...
			expectError:   true,
			expectedError: "[CTX: ERR_XCONFIG][ERR: E3007][MSG: mutual exclusivity violation (choose only one)][INFO: 'FilePath': '/path/to/config.json' | 'DirPath': '' | 'ConfigPath': '/path/to/generic']",
		},
		{
			...
			expectError:   true,
			expectedError: "[CTX: ERR_XCONFIG][ERR: E3007][MSG: mutual exclusivity violation (choose only one)][INFO: 'FilePath': '' | 'DirPath': '/path/to/dir' | 'ConfigPath': '/path/to/generic']",
		},
		{
			...
			expectError:   true,
			expectedError: "[CTX: ERR_XCONFIG][ERR: E3007][MSG: mutual exclusivity violation (choose only one)][INFO: 'FilePath': '/path/to/config.json' | 'DirPath': '/path/to/dir' | 'ConfigPath': '/path/to/generic']",
		},
	}
...
func TestOptions_ValidatePrefixAndSeparator(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectError:   true,
			expectedError: "[CTX: ERR_XCONFIG][ERR: E1003][MSG: empty string value not allowed][INFO: 'field': 'Prefix']",
		},
		{
			...
			expectError:   true,
			expectedError: "[CTX: ERR_XCONFIG][ERR: E1003][MSG: empty string value not allowed][INFO: 'field': 'Separator']",
		},
		{
