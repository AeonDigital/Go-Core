...
type IPkgBridgeXFS interface {
	...
	GetUserDataDir(appName string) (string, error)
	GetUserLogDir(appName string) (string, error)
	GetParentPath(filePath string) (string, error)
...
func (PkgBridgeXFS) GetUserDataDir(path string) (string, error) {
	return GetUserDataDir(path)
}
func (PkgBridgeXFS) GetUserLogDir(path string) (string, error) {
	return GetUserLogDir(path)
}
func (PkgBridgeXFS) GetParentPath(path string) (string, error) {
	return GetParentPath(path)
}
func (PkgBridgeXFS) OSUserDataDir(home string, appName string) string {
	return osUserDataDir(home, appName)
}
func (PkgBridgeXFS) OSUserLogDir(home string, appName string) string {
